            ...
            articles.append(
                {
                    ...
                    "text": parse_article(html_element)
                }
            )
    return articles


def parse_article(html_element):
    result = {}
    section: html.HtmlElement
    for section in html_element.xpath("//article/section"):
        sect_header = get_whole_text(section.xpath("./div/h2/descendant::text()"))
